...
function(AppliedArgs, MaxArity) ->
    Clauses = [clause(FunArity, AppliedArgs) || FunArity <- lists:seq(AppliedArgs, MaxArity)],
...
clause_guard(FunArity) ->
    [[{call, 0, {atom, 0, is_function}, [{var, 0, 'Fun'}, {integer, 0, FunArity}]}]].
    ...
    [{'fun',
      ...
      {clauses,
       [{clause,
         ...
         [],
         [{call, 0, {var, 0, 'Fun'}, args(1, FunArity)}]}]}}].
